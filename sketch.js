...
function draw() {
  ...
  fill(255,0,255); 
  textSize(20);
  text("This is a simulator that can test car reliability.",430,100);

  fill(64,224,208);
  textSize(22);
  text("GLOBAL CAR SAFETY ORGANISATION(GCSO)",430,50);
  ...
  fill("orange");
  textSize(20);
  text("Here's the calculated deformation :",880,380);
...
function deform(){
  ...
  if(deformation<100){
    ...
    fill("green");
    textSize(20);
    text(Math.round(deformation),1200,380);
    text("{Safe}",1000,270);
  }
